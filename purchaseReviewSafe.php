<?php
      if (isset($_POST['cancel'])) {
        // might as well make the nav bar match
        echo "<ul id=\"navBarList\"><a class=\"navBarItem kutz\" href=\"confirmationPage.php\"><li>Order Cancelled</li></a></ul>";
        echo "<h3>Your order has been canceled</h3>";
     } else {
        echo "<ul id=\"navBarList\"><a class=\"navBarItem kutz\" href=\"confirmationPage.php\"><li>Confirmation</li></a></ul>";
        echo "<h3>Thank you for shopping with us! Your kut files are on their way to your email address.</h3>";
    ?>


        <ul id="navBarList">
      <a class="navBarItem kutz" href="purchaseReview.php"><li>Order Review</li></a>
    </ul>
    <?php
     if (isset($_POST['cancel'])) {
       echo "<h3>Your order has been canceled</h3>";
